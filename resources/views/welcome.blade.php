...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800 fw-bold">
        <i class="fas fa-tachometer-alt fa-fw text-warning me-2"></i> Dashboard
    </h1>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Jumlah Dosen</div>
