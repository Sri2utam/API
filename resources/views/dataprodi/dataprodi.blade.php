...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-gray-800">
            <i class="fas fa-fw fa-graduation-cap fa-fw text-warning me-2"></i> Data Prodi
        </h1>
        <a href="{{ route('dataprodi.create') }}" class="btn btn-warning btn-sm shadow-sm">
                ...
                <table class="table table-bordered align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-warning">{{ $item->jenjang_prodi }}</span>
                            </td>
