...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-warning-800 fw-bold">
            <i class="fas fa-university fa-fw text-warning me-2"></i> Data Fakultas
        </h1>
        <a href="{{ route('datafakultas.create') }}" class="btn warning btn-warning shadow-sm">
