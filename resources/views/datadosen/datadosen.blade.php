...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-dark-800">
            <i class="fas fa-chalkboard-teacher fa-fw text-warning"></i> Data Dosen
        </h1>
        <a href="{{ route('datadosen.create') }}" class="btn btn-warning btn-sm shadow-sm">
