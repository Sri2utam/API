...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800">
            <i class="fas fa-users fa-fw text-warning"></i> Tambah Data Mahasiswa
        </h1>
        <a href="{{ route('datamahasiswa.index') }}" class="btn btn-warning btn-sm shadow-sm">
            <i class="fas fa-arrow-left fa-sm text-warning-50"></i> Kembali
        </a>
    </div>

    <!-- Card Form -->
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-warning text-gray">
