...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800">
            <i class="fas fa-users fa-fw text-warning"></i> Data Mahasiswa
        </h1>
        <a href="{{ route('datamahasiswa.create') }}" class="btn btn-warning btn-sm shadow-sm">
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header bg-warning text-white fw-semibold rounded-top-4">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('datamahasiswa.destroy', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-warning" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
        ...
        @else
            <div class="text-center py-5">
                ...
                <a href="{{ route('datamahasiswa.create') }}" class="btn btn-warning">
